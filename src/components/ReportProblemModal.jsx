          ...
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-amber-500/7 flex items-center justify-center">
              <svg
                ...
                stroke="currentColor"
                strokeWidth="1.5"
                className="w-4.5 h-4.5 text-amber-400/70"
              >
                <path
                  strokeLinecap="round"
            ...
            <>
              ...
              <div>
                ...
                <div className="flex justify-between mt-1">
                  <span
                    className={`text-xs ${description.trim().length < 10 ? 'text-muted' : 'text-green/60'}`}
                  >
              ...
              <div>
                ...
                {!screenshot ? (
                  <div>
                    ...
                    {fileError && <p className="text-red-400/70 text-xs mt-1.5">{fileError}</p>}
                  </div>
                ) : (
