...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden noise-overlay">
      ...
      <div
        className="absolute top-1/4 -left-32 w-96 h-96 bg-green/6 rounded-full blur-[128px]"
        style={{ animation: 'float 8s ease-in-out infinite' }}
      />
      <div
        className="absolute bottom-1/4 -right-32 w-80 h-80 bg-blue/10 rounded-full blur-[100px]"
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(91,192,222,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(91,192,222,0.3) 1px, transparent 1px)',
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-24">
        ...
        <div className="animate-fade-in-up inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface/80 border border-blue/20 mb-8">
          ...
          <span className="text-blue text-xs font-medium tracking-wide uppercase">
        ...
        <h1 className="animate-fade-in-up delay-100 text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-green leading-[1.1] mb-6 font-bold">
          Get Your Loan Approved <span className="text-shimmer">Faster</span>
        </h1>
        ...
        <p className="animate-fade-in-up delay-200 text-white text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <span className="text-white font-medium">GR8 Lending Corporation</span> — your local
          lending partner in Bulacan.
        </p>
