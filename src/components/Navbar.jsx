    ...
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-canvas/80 border-b border-border">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            to="/apply"
            className="px-5 py-2.5 bg-green hover:bg-green-hover text-white font-semibold text-sm rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green/25"
          >
            Apply Now
          </Link>
        </div>
        ...
        <div className="md:hidden bg-surface/95 backdrop-blur-xl border-t border-border animate-fade-in">
          <div className="px-6 py-4 flex flex-col gap-4">
            ...
            <Link
              to="/apply"
              onClick={() => setMenuOpen(false)}
              className="px-5 py-3 bg-green hover:bg-green-hover text-white font-semibold text-sm rounded-lg text-center"
            >
              Apply Now
            </Link>
          </div>
